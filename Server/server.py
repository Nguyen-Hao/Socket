...
class NextPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label_title = tk.Label(self, text="\nSEVER SETTING\n", font=LARGE_FONT, fg='#209b93', bg=BG).grid(
            row=0, column=1)
        label_nClient = tk.Label(self, text="\tNUMBER OF CLIENTS ", fg='#209b93', bg=BG, font='consolas 11 bold').grid(row=1,                                                                                                         column=0)
        self.label_notice = tk.Label(self, text="", bg=BG, fg='red')
...
class HomePage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label_title2=tk.Label(self, text="\n HISTORY\n", font="consolas 14 bold", fg="#209b93", bg=BG).place(x=200, y=300)
